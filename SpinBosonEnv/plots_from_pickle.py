...
def plot_from_pickle(pickle_path):
    ...
    fig1.savefig(write_folder + f"Nx_RealSpace_occupation_{sim_label}.pdf", dpi=600, bbox_inches="tight")
    fig2.savefig(write_folder + f"Energy_{sim_label}.pdf", dpi=600, bbox_inches="tight")
    fig3.savefig(write_folder + f"Entropy_{sim_label}.pdf", dpi=600, bbox_inches="tight")
    fig4.savefig(write_folder + f"SpinOps_{sim_label}.pdf", dpi=600, bbox_inches="tight")
