...
from SpinBosonEnv.OhmicModels import OhmicModel, SubSubOhmicModel, SubSubOhmic32Model, TFMOhmicModel
...
class GeneralSpinBosonEnv:
    def __init__(self, SB_params):
        ...
        elif SB_params["ohmic_model"] == "SubSubOhmic32":
            ohmic_model = SubSubOhmic32Model
